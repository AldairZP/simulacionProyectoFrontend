...
async function getCSRFToken() {
    const fetchCSRFToken = await fetch('http://104.197.151.60/csrf/');
...
async function fetchLogout() {
    try {
        const response = await fetch('http://104.197.151.60/logout/', {
            method: 'GET',
...
async function fetchDataUser() {
    try {
        const response = await fetch('http://104.197.151.60/user_info/',{
            method: 'GET',
